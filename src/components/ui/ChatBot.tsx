...
const i18n: Record<string, Record<string, string>> = {
  es: {
    header: 'AlexAI',
    welcomeZone: '¡Hola! Soy AlexAI, tu asistente para {propertyName}. Estoy aquí para ayudarte con cualquier pregunta sobre {zoneName} y tu estancia. ¿En qué puedo ayudarte?',
    welcomeProperty: '¡Hola! Soy AlexAI, tu asistente para {propertyName}. Puedo ayudarte con cualquier pregunta sobre el alojamiento, check-in, servicios y más. ¿En qué puedo ayudarte?',
    ...
    welcomeBubble: '¡Hola! Soy AlexAI, el asistente de {propertyName} 👋 Si tienes alguna duda durante tu estancia, puedes consultarme aquí.',
    ...
    demoWelcome: '¡Hola! Soy AlexAI, el asistente IA de {propertyName}. Tus huespedes pueden preguntarme cualquier cosa sobre tu alojamiento, 24/7, en 3 idiomas.\n\nPruebame: preguntame donde esta el WiFi, como funciona el check-in, o que restaurantes hay cerca',
  ...
  en: {
    header: 'AlexAI',
    welcomeZone: 'Hello! I\'m AlexAI, your assistant for {propertyName}. I\'m here to help you with any questions about {zoneName} and your stay. How can I help you?',
    welcomeProperty: 'Hello! I\'m AlexAI, your assistant for {propertyName}. I can help you with any questions about the accommodation, check-in, services and more. How can I help you?',
    ...
    welcomeBubble: 'Hello! I\'m AlexAI, the assistant for {propertyName} 👋 If you have any questions during your stay, you can ask me here.',
    welcomeBubbleSuggestions: 'How to check in|WiFi password|What to visit|Restaurants nearby',
    welcomeBubbleDismiss: 'Maybe later',
    demoWelcome: 'Hello! I\'m AlexAI, the AI assistant for {propertyName}. Your guests can ask me anything about your accommodation, 24/7, in 3 languages.\n\nTry me: ask where the WiFi is, how check-in works, or what restaurants are nearby',
  ...
  fr: {
    header: 'AlexAI',
    welcomeZone: 'Bonjour ! Je suis AlexAI, votre assistant pour {propertyName}. Je suis là pour vous aider avec toute question sur {zoneName} et votre séjour. Comment puis-je vous aider ?',
    welcomeProperty: 'Bonjour ! Je suis AlexAI, votre assistant pour {propertyName}. Je peux vous aider avec toute question sur l\'hébergement, l\'enregistrement, les services et plus encore. Comment puis-je vous aider ?',
    ...
    welcomeBubble: 'Bonjour ! Je suis AlexAI, l\'assistant de {propertyName} 👋 Si vous avez des questions pendant votre séjour, vous pouvez me consulter ici.',
    ...
    demoWelcome: 'Bonjour ! Je suis AlexAI, l\'assistant IA de {propertyName}. Vos invites peuvent me poser n\'importe quelle question sur votre hebergement, 24h/24, en 3 langues.\n\nEssayez-moi : demandez-moi ou se trouve le WiFi, comment fonctionne l\'enregistrement, ou quels restaurants se trouvent a proximite',
