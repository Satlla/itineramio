...
export function ZoneIconDisplay({ iconId, size = 'md', className }: ZoneIconDisplayProps) {
  ...
  if (!IconComponent && iconId) {
    ...
    const iconIdMapping: { [key: string]: any } = {
      ...
      'door-exit': getZoneIconByName('check out'),
      ...
      'navigation': getZoneIconByName('llegar'),
      ...
      'washing-machine': getZoneIconByName('lavadora'),
      'dishwasher': getZoneIconByName('cocina'),
      'coffee': getZoneIconByName('cafetera'),
      'oven': getZoneIconByName('cocina'),
      'microwave': getZoneIconByName('cocina'),
      'cooktop': getZoneIconByName('cocina'),
      'wind': getZoneIconByName('aire'),
      'rules': getZoneIconByName('normas'),
      'volume-off': getZoneIconByName('silencio'),
      'smoking': getZoneIconByName('fumar'),
      'pet': getZoneIconByName('mascotas'),
      'recycle': getZoneIconByName('reciclaje'),
      'train': getZoneIconByName('transporte'),
      'shopping-cart': getZoneIconByName('supermercados'),
      'beach': getZoneIconByName('playa'),
      'pool': getZoneIconByName('piscina'),
      'gym': getZoneIconByName('gimnasio'),
      'alarm': getZoneIconByName('emergencias')
    }
