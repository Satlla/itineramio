        ...
        >
          <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-300 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="relative p-5 sm:p-6">
              ...
              <button
                onClick={handleClose}
                className="absolute top-3 right-3 w-8 h-8 rounded-full bg-amber-200/50 hover:bg-amber-300/50 flex items-center justify-center transition-colors group"
              >
                <X className="w-4 h-4 text-amber-700 group-hover:text-amber-900" />
              </button>
                ...
                <div className="flex-1 pt-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-5 py-2.5 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 text-sm sm:text-base"
                    >
                    ...
                    <button
                      onClick={handleClose}
                      className="px-5 py-2.5 bg-white/80 hover:bg-white text-amber-800 rounded-lg font-medium border border-amber-200 hover:border-amber-300 transition-colors text-sm sm:text-base"
                    >
                      Más tarde
                    </button>
                  </div>
