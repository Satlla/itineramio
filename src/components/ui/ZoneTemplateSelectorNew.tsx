          ...
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-600">
              {selectedZones.length > 0 ? (
                ...
                <div>
                  <p>Selecciona las zonas que quieres añadir</p>
                  <button
                    onClick={() => {
                      onCreateCustomZone()
                      onClose()
                    }}
                    className="text-violet-600 hover:text-violet-800 text-xs underline mt-1"
                  >
                    ¿No encuentras la zona que necesitas? → Crear zona personalizada
                  </button>
                </div>
              )}
            </div>
