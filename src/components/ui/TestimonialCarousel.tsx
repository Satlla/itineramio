...
const testimonials: Testimonial[] = [
  {
    ...
    content: "Desde que uso ManualPhi, las consultas de mis huéspedes se han reducido un 80%. Ya no tengo que buscar videos en mi galería para explicar cómo funciona la lavadora. Simplemente escanean el QR y ya saben todo.",
    rating: 5,
    avatar: "MG",
  ...
  },
  {
    ...
    content: "Ya no explico por teléfono cómo desbloquear la vitrocerámica. Con ManualPhi, cada electrodoméstico tiene su QR con instrucciones claras. Mis huéspedes están encantados.",
    rating: 5,
    avatar: "JM",
  ...
  },
  {
    ...
    content: "ManualPhi ha revolucionado mi negocio. Los huéspedes acceden al manual desde mis mensajes automáticos y tienen toda la información que necesitan al instante.",
    rating: 5,
    avatar: "CT",
  ...
  },
  {
    ...
    content: "Mi loft tiene equipos modernos que pueden ser complicados. Con los QR de ManualPhi, hasta los huéspedes menos tecnológicos los usan sin problemas.",
    rating: 5,
    avatar: "IM",
  ...
  },
  {
    ...
    content: "Tengo 5 propiedades y ManualPhi ha sido un salvavidas. Cada una tiene su manual personalizado y ya no recibo consultas repetitivas. Increíble eficiencia.",
    rating: 5,
    avatar: "MC",
