...
export function ItineramioLogo({
  ...
  // Contains the isotipo centered inside
  const SquareLogo = () => (
    <svg
      width={squareSize}
      height={squareSize}
