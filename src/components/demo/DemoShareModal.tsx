      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full sm:max-w-md bg-white border border-gray-200 sm:rounded-2xl rounded-t-2xl overflow-hidden shadow-xl"
          >
            {/* Header */}
            ...
            <div className="px-5 pb-5">
              <button
                ...
                className="w-full flex items-center gap-3 p-3.5 rounded-xl border border-gray-200 hover:border-gray-300 bg-gray-50 transition-all"
              >
