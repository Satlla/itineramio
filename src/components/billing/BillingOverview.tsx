...
export const BillingOverview: React.FC<BillingOverviewProps> = ({
  ...
  const freePropertiesLimit = 1
  const usedFreeSlots = Math.min(propertyCount, freePropertiesLimit)
  const uncoveredProperties = Math.max(0, propertyCount - subscriptionsData.totalSlots - freePropertiesLimit)
              ...
              <div className="ml-4">
                ...
                <div className="text-lg font-bold text-gray-900">
                  ...
                  <span className="text-sm text-gray-500 ml-1">
                    ({subscriptionsData.totalSlots + freePropertiesLimit} slots)
                  </span>
                </div>
              </div>
            </div>
