...
const AMENITIES: Amenity[] = [
  ...
  { id: 'conditioner', name: { es: 'Acondicionador', en: 'Conditioner', fr: 'Après-shampooing' }, category: 'bathroom', icon: 'droplets' },
  { id: 'body_wash', name: { es: 'Gel de ducha', en: 'Body wash', fr: 'Gel douche' }, category: 'bathroom', icon: 'droplets' },
  ...
  { id: 'towels', name: { es: 'Toallas', en: 'Towels', fr: 'Serviettes' }, category: 'bathroom', icon: 'bath' },
  { id: 'bidet', name: { es: 'Bidé', en: 'Bidet', fr: 'Bidet' }, category: 'bathroom', icon: 'droplets' },

  // Dormitorio y lavandería
  { id: 'bed_linens', name: { es: 'Ropa de cama', en: 'Bed linens', fr: 'Linge de lit' }, category: 'bedroom', icon: 'bed' },
  ...
  { id: 'blackout_curtains', name: { es: 'Persianas o cortinas opacas', en: 'Blackout curtains', fr: 'Rideaux occultants' }, category: 'bedroom', icon: 'eye-off' },
  { id: 'iron', name: { es: 'Plancha', en: 'Iron', fr: 'Fer à repasser' }, category: 'bedroom', icon: 'shirt' },
  { id: 'ironing_board', name: { es: 'Tabla de planchar', en: 'Ironing board', fr: 'Table à repasser' }, category: 'bedroom', icon: 'shirt' },
  { id: 'wardrobe', name: { es: 'Armario', en: 'Wardrobe', fr: 'Armoire' }, category: 'bedroom', icon: 'box' },
  { id: 'dresser', name: { es: 'Cómoda', en: 'Dresser', fr: 'Commode' }, category: 'bedroom', icon: 'box' },
  { id: 'clothes_rack', name: { es: 'Tendedero', en: 'Clothes rack', fr: 'Étendoir' }, category: 'bedroom', icon: 'shirt' },
  { id: 'washer', name: { es: 'Lavadora', en: 'Washing machine', fr: 'Machine à laver' }, category: 'bedroom', icon: 'shirt' },
  ...
  // Cocina y comedor
  { id: 'kitchen', name: { es: 'Cocina', en: 'Kitchen', fr: 'Cuisine' }, category: 'kitchen', icon: 'utensils' },
  { id: 'fridge', name: { es: 'Nevera', en: 'Refrigerator', fr: 'Réfrigérateur' }, category: 'kitchen', icon: 'snowflake' },
  { id: 'freezer', name: { es: 'Congelador', en: 'Freezer', fr: 'Congélateur' }, category: 'kitchen', icon: 'snowflake' },
  { id: 'microwave', name: { es: 'Microondas', en: 'Microwave', fr: 'Micro-ondes' }, category: 'kitchen', icon: 'zap' },
  { id: 'oven', name: { es: 'Horno', en: 'Oven', fr: 'Four' }, category: 'kitchen', icon: 'flame' },
  { id: 'stove', name: { es: 'Vitrocerámica', en: 'Stove', fr: 'Plaque de cuisson' }, category: 'kitchen', icon: 'flame' },
  { id: 'dishwasher', name: { es: 'Lavavajillas', en: 'Dishwasher', fr: 'Lave-vaisselle' }, category: 'kitchen', icon: 'utensils' },
  { id: 'coffee_maker', name: { es: 'Cafetera', en: 'Coffee maker', fr: 'Cafetière' }, category: 'kitchen', icon: 'coffee' },
  { id: 'kettle', name: { es: 'Hervidor de agua', en: 'Kettle', fr: 'Bouilloire' }, category: 'kitchen', icon: 'coffee' },
  { id: 'toaster', name: { es: 'Tostadora', en: 'Toaster', fr: 'Grille-pain' }, category: 'kitchen', icon: 'utensils' },
  ...
  { id: 'dishes', name: { es: 'Platos y cubiertos', en: 'Dishes and silverware', fr: 'Vaisselle et couverts' }, category: 'kitchen', icon: 'utensils' },
  { id: 'dining_table', name: { es: 'Mesa de comedor', en: 'Dining table', fr: 'Table à manger' }, category: 'kitchen', icon: 'utensils' },
  ...
  { id: 'board_games', name: { es: 'Juegos de mesa', en: 'Board games', fr: 'Jeux de société' }, category: 'entertainment', icon: 'gamepad-2' },

  // Calefacción y refrigeración
  { id: 'ac', name: { es: 'Aire acondicionado', en: 'Air conditioning', fr: 'Climatisation' }, category: 'climate', icon: 'snowflake' },
  { id: 'heating', name: { es: 'Calefacción', en: 'Heating', fr: 'Chauffage' }, category: 'climate', icon: 'thermometer' },
  ...
  { id: 'workspace', name: { es: 'Zona de trabajo', en: 'Workspace', fr: 'Espace de travail' }, category: 'office', icon: 'monitor' },

  // Seguridad
  { id: 'smoke_detector', name: { es: 'Detector de humo', en: 'Smoke detector', fr: 'Détecteur de fumée' }, category: 'safety', icon: 'shield' },
  { id: 'co_detector', name: { es: 'Detector de monóxido de carbono', en: 'Carbon monoxide detector', fr: 'Détecteur de monoxyde de carbone' }, category: 'safety', icon: 'shield' },
  { id: 'first_aid', name: { es: 'Botiquín', en: 'First aid kit', fr: 'Trousse de secours' }, category: 'safety', icon: 'heart' },
  { id: 'fire_extinguisher', name: { es: 'Extintor', en: 'Fire extinguisher', fr: 'Extincteur' }, category: 'safety', icon: 'flame' },
  { id: 'safe', name: { es: 'Caja fuerte', en: 'Safe', fr: 'Coffre-fort' }, category: 'safety', icon: 'lock' },
  { id: 'bedroom_lock', name: { es: 'Cerradura en el dormitorio', en: 'Bedroom lock', fr: 'Serrure de chambre' }, category: 'safety', icon: 'lock' },

  // Aparcamiento e instalaciones
  { id: 'free_parking', name: { es: 'Parking gratuito', en: 'Free parking', fr: 'Parking gratuit' }, category: 'facilities', icon: 'car' },
  { id: 'paid_parking', name: { es: 'Parking de pago', en: 'Paid parking', fr: 'Parking payant' }, category: 'facilities', icon: 'car' },
  { id: 'elevator', name: { es: 'Ascensor', en: 'Elevator', fr: 'Ascenseur' }, category: 'facilities', icon: 'arrow-up' },
  ...
  { id: 'jacuzzi', name: { es: 'Jacuzzi', en: 'Hot tub', fr: 'Jacuzzi' }, category: 'outdoor', icon: 'waves' },
  ...
  { id: 'bbq', name: { es: 'Barbacoa', en: 'BBQ', fr: 'Barbecue' }, category: 'outdoor', icon: 'flame' },
  { id: 'balcony', name: { es: 'Balcón', en: 'Balcony', fr: 'Balcon' }, category: 'outdoor', icon: 'sun' },
  { id: 'patio', name: { es: 'Patio', en: 'Patio', fr: 'Patio' }, category: 'outdoor', icon: 'sun' },

  // Servicios
  { id: 'long_stays', name: { es: 'Estancias largas', en: 'Long stays', fr: 'Longs séjours' }, category: 'services', icon: 'calendar' },
  { id: 'self_checkin', name: { es: 'Llegada autónoma', en: 'Self check-in', fr: 'Arrivée autonome' }, category: 'services', icon: 'key' },
  { id: 'pets_allowed', name: { es: 'Se admiten mascotas', en: 'Pets allowed', fr: 'Animaux acceptés' }, category: 'services', icon: 'heart' },
]
