      ...
      <table width="100%" cellPadding={0} cellSpacing={0} style={{ maxWidth: '580px', margin: '0 auto' }}>
        <tr>
          <td style={{ textAlign: 'center', paddingBottom: '32px' }}>
            ...
            <h1 style={{ margin: '0 0 12px 0', color: '#1a1a1a', fontSize: '24px', fontWeight: 600 }}>Tu perfil oculto de anfitrion</h1>
          </td>
        </tr>
        ...
        <tr>
          <td style={{ backgroundColor: '#ffffff', borderRadius: '12px', padding: '32px', border: '1px solid #e5e7eb' }}>
            ...
            <p style={{ margin: '0 0 20px 0', color: '#374151', fontSize: '16px', lineHeight: 1.6 }}>
              En el ultimo email te hable de por que la experiencia del huesped es mas importante que el marketing.
            </p>

            <p style={{ margin: '0 0 20px 0', color: '#374151', fontSize: '16px', lineHeight: 1.6 }}>
              Hoy quiero ir un paso mas alla.
            </p>

            <p style={{ margin: '0 0 20px 0', color: '#374151', fontSize: '16px', lineHeight: 1.6 }}>
              Despues de analizar cientos de anfitriones, he identificado <strong>8 perfiles diferentes</strong>.
            </p>
            ...
            <ul style={{ margin: '0 0 24px 0', paddingLeft: '20px', color: '#374151', fontSize: '15px', lineHeight: 1.8 }}>
              ...
              <li>Estrategias especificas que le funcionan</li>
            </ul>
            ...
            <div style={{ backgroundColor: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '16px', marginBottom: '24px' }}>
              <p style={{ margin: '0 0 8px 0', color: '#374151', fontSize: '14px' }}>
                <strong>El Estratega</strong> es genial con numeros pero descuida el toque personal.
              </p>
              <p style={{ margin: '0 0 8px 0', color: '#374151', fontSize: '14px' }}>
                <strong>El Experiencial</strong> crea momentos wow pero se agota porque no delega.
              </p>
              <p style={{ margin: 0, color: '#374151', fontSize: '14px' }}>
                <strong>El Ejecutor</strong> lo hace todo el mismo pero nunca escala.
              </p>
            </div>
            ...
            <ul style={{ margin: '0 0 24px 0', paddingLeft: '20px', color: '#374151', fontSize: '15px', lineHeight: 1.8 }}>
              ...
              <li>Una guia personalizada para tu tipo</li>
            </ul>
            ...
            <div style={{ textAlign: 'center', marginBottom: '32px' }}>
              <a href="https://www.itineramio.com/host-profile/test" style={{ display: 'inline-block', backgroundColor: '#7c3aed', color: '#ffffff', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: 600, fontSize: '16px' }}>
                Descubre tu arquetipo de anfitrion
              </a>
            </div>
            ...
            <div style={{ backgroundColor: '#f0fdf4', border: '1px solid #86efac', borderRadius: '12px', padding: '24px', marginBottom: '24px' }}>
              ...
              <p style={{ margin: '0 0 16px 0', color: '#166534', fontSize: '15px', lineHeight: 1.6 }}>
                Hablando de experiencia del huesped...
              </p>
              <p style={{ margin: '0 0 16px 0', color: '#166534', fontSize: '15px', lineHeight: 1.6 }}>
                La limpieza es lo #1 que mencionan las resenas negativas.
              </p>
              <p style={{ margin: '0 0 16px 0', color: '#166534', fontSize: '15px', lineHeight: 1.6 }}>
                He preparado un checklist interactivo con <strong>50+ items</strong> organizados por zona (cocina, banos, dormitorios, exteriores) que puedes personalizar con el nombre de tu alojamiento.
              </p>
            ...
            <p style={{ margin: '0 0 20px 0', color: '#374151', fontSize: '16px', lineHeight: 1.6 }}>
              Por que te doy todo esto gratis?
            </p>

            <p style={{ margin: '0 0 20px 0', color: '#374151', fontSize: '16px', lineHeight: 1.6 }}>
              Porque se que cuando mejores tu operacion, eventualmente querras automatizarla. Y ahi es donde podemos ayudarte.
            </p>
            ...
            <p style={{ margin: '20px 0 0 0', color: '#6b7280', fontSize: '14px' }}>
              P.D. Si tu equipo de limpieza ya usa un checklist, comparalo con el nuestro. Te sorprendera lo que falta.
            </p>
          </td>
        </tr>
