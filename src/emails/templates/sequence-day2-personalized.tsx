...
const ARCHETYPE_CONTENT: Record<EmailArchetype, {
  ...
  ESTRATEGA: {
    ...
    hook: 'Como ESTRATEGA, tu don es analizar y optimizar datos. Pero muchos anfitriones con tu perfil cometen un error muy común...',
  ...
  DIFERENCIADOR: {
    ...
    hook: 'Tu don de DIFERENCIADOR es único. Mientras otros copian descripciones genéricas, tú sabes crear experiencias. Pero mucho de ese talento se pierde en las OTAs.',
  ...
  EJECUTOR: {
    ...
    hook: 'Como EJECUTOR, resuelves problemas rápido. Pero estás atrapado: trabajas demasiadas horas y no puedes crecer porque estás apagando fuegos 24/7.',
  ...
  IMPROVISADOR: {
    ...
    hook: 'Trabajas "sobre la marcha" y siempre vas apagando fuegos. Muchos anfitriones con tu perfil luchan el primer año. Pero tú NO vas a ser uno de ellos.',
