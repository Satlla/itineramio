...
export const Day10TrialEmail: React.FC<Day10TrialEmailProps> = ({
  name,
  gender,
  archetype
}) => {
  ...
  // Texto adaptado por género (no hay usos específicos en este email, pero lo dejamos preparado)
          ...
          <div style={{ padding: '0 20px' }}>
            ...
            <div style={{
              ...
              <ul style={{
                ...
                <li>Prueba 15 días sin compromiso con 1 click</li>
            ...
            <p style={{
              ...
              PD: Si tienes dudas sobre si Itineramio es para ti, responde este email con tus preguntas. Te respondo personalmente en <24 horas.
            </p>
          </div>
...
export default Day10TrialEmail
