...
// Same formatting functions as previous batches
...
async function main() {
  console.log('📝 FORMATTING BLOG ARTICLES - BATCH 3 (Articles 13-18)');
  console.log('='.repeat(80));

  const batch3 = [
    { id: 'cmhdywg9500057cm2ik2mftj9', slug: 'operaciones-check-in' },
    { id: 'cmhdywfym00047cm2l8j6nizb', slug: '10-trucos-marketing' },
    { id: 'cmhdywfny00037cm2tx0suxd6', slug: 'automatizacion-anfitriones' },
    { id: 'cmhdywfd500027cm2gfahej8p', slug: 'normativa-vut-2025' },
    { id: 'cmhdywf2500017cm25c5cwhps', slug: 'manual-digital-apartamentos' },
    { id: 'cmhdyweq700007cm243p73ujg', slug: 'como-optimizar-precio' },
  ];
  ...
  console.log(`\n✅ Successfully formatted: ${successful}/${batch3.length}`);
  console.log(`❌ Failed: ${failed}/${batch3.length}`);
