...
const newContent = `<style>
  ...
  .cta-banner-alt { background: linear-gradient(135deg, #059669 0%, #047857 100%); border-radius: 16px; padding: 2rem; margin: 2.5rem 0; text-align: center; color: white; }
  .cta-banner-alt h4 { font-size: 1.375rem; font-weight: 700; margin: 0 0 0.75rem 0; color: white; }
  .cta-banner-alt p { font-size: 1rem; margin: 0 0 1.25rem 0; opacity: 0.9; }
  .cta-banner-alt a { display: inline-block; background: white; color: #059669; font-weight: 700; padding: 0.875rem 2rem; border-radius: 8px; text-decoration: none; }
...
<h2 class="section-title">El método de 4 fases</h2>
...
<div class="phase-card">
  ...
  <div class="timing">24-48 horas antes del check-in</div>
  <p>Envías el enlace de check-in con todas las instrucciones (vídeo, fotos, ubicación) e invitas a ver la guía completa del alojamiento. Le ahorras tiempo al huésped y reduces preguntas.</p>
</div>

<div class="phase-card">
  <h4>Fase 2: Confirmación de disponibilidad</h4>
  <div class="timing">Cuando el alojamiento está listo</div>
  <p>Si tienes entrada autónoma: avisas que el alojamiento ya está disponible. Si tienes entrada presencial: confirmas la hora de llegada. Simple y directo.</p>
</div>

<div class="phase-card">
  <h4>Fase 3: Validación de estancia</h4>
  <div class="timing">Al día siguiente de la llegada</div>
  <p>Preguntas cómo fue la primera noche y envías una breve encuesta de satisfacción. Esto te da tiempo para solucionar cualquier problema antes del checkout.</p>
</div>

<div class="phase-card">
  <h4>Fase 4: Cierre elegante</h4>
  <div class="timing">2-12 horas después del checkout</div>
  <p>Cierras el ciclo con agradecimiento genuino y un recordatorio sutil sobre el significado de las estrellas en la evaluación.</p>
</div>

<h2 class="section-title">Los scripts exactos</h2>

<h3 class="subsection-title">Fase 1: Pre-llegada (24-48h antes)</h3>

<div class="script-box">
  <div class="script-box-title">Mensaje</div>
  <p>Hola <span class="highlight">[Nombre]</span>,

¡Ya falta poco para tu llegada! Te envío toda la información para que tu check-in sea lo más sencillo posible:

<span class="highlight">[ENLACE AL CHECK-IN DIGITAL]</span>

Ahí encontrarás:
- Instrucciones de acceso con vídeo y fotos
- Ubicación exacta en Google Maps
- Código de entrada (se activará a partir de las <span class="highlight">[HORA]</span>)

También te invito a ver la guía completa del alojamiento donde encontrarás información útil como:
- Cómo llegar desde el aeropuerto
- Dónde aparcar
- Supermercados cercanos
- Restaurantes recomendados

<span class="highlight">[ENLACE A LA GUÍA]</span>

Si tienes cualquier duda antes de llegar, escríbeme por aquí.

¡Buen viaje!</p>
</div>

<div class="info-box">
  <div class="info-box-title">Por qué funciona este mensaje</div>
  <ul>
    <li>Le das toda la información en un solo lugar (no 10 mensajes separados)</li>
    <li>El código solo se activa a la hora correcta (evitas problemas de llegadas anticipadas)</li>
    <li>La guía le ahorra tiempo al huésped y reduce las preguntas típicas</li>
    <li>Demuestras profesionalidad desde antes de que llegue</li>
  </ul>
</div>

<div class="tip-box">
  <div class="tip-box-title">Sobre la guía del alojamiento</div>
  <p>La guía es tu oportunidad de aportar valor real. Incluye información como: cómo llegar desde el aeropuerto, dónde aparcar, dónde dejar las maletas si llegan antes (con descuento si lo consigues), supermercado más cercano, restaurantes favoritos, planes según el tipo de viajero. Cuanto más útil sea la guía, mejor impresión genera.</p>
</div>

<h3 class="subsection-title">Fase 2: Confirmación de disponibilidad</h3>

<p><strong>Opción A: Entrada autónoma</strong></p>

<div class="script-box">
  <div class="script-box-title">Mensaje</div>
  <p>Hola <span class="highlight">[Nombre]</span>,

Tu alojamiento ya está listo y disponible para cuando quieras entrar.

El código de acceso ya está activo. Tienes todas las instrucciones en el enlace de check-in que te envié.

¡Que disfrutes la estancia!</p>
</div>

<p><strong>Opción B: Entrada presencial</strong></p>

<div class="script-box">
  <div class="script-box-title">Mensaje</div>
  <p>Hola <span class="highlight">[Nombre]</span>,

El alojamiento estará listo a las <span class="highlight">[HORA]</span>. ¿Me confirmas a qué hora aproximada llegaréis para estar pendiente?

Si surge cualquier cambio en vuestros planes, avísame sin problema.</p>
</div>

<h3 class="subsection-title">Fase 3: Validación de estancia (día siguiente)</h3>

<div class="script-box">
  <div class="script-box-title">Mensaje</div>
  <p>Hola <span class="highlight">[Nombre]</span>, ¿qué tal la primera noche?

Me encantaría saber si todo está en orden y si hay algo que pueda mejorar durante vuestra estancia.

Si tienes 1 minuto, te dejo esta breve encuesta de satisfacción que me ayuda muchísimo a seguir mejorando:

<span class="highlight">[ENLACE A ENCUESTA GOOGLE FORMS]</span>

Cualquier cosa que necesites, aquí estoy.</p>
</div>

<div class="cta-banner-alt">
  <h4>Crea tu encuesta de satisfacción con Google Forms</h4>
  <p>Te explicamos paso a paso cómo crear una encuesta profesional, qué preguntas incluir y cómo analizar las respuestas para mejorar tu servicio.</p>
  <a href="/blog/como-crear-encuestas-satisfaccion-huespedes-google-forms">Ver guía completa</a>
</div>

<div class="tip-box">
  <div class="tip-box-title">Por qué enviar encuesta al día siguiente</div>
  <p>La encuesta al día siguiente te da tiempo de reaccionar. Si el huésped indica algún problema, tienes margen para solucionarlo antes del checkout. Un problema resuelto rápidamente puede convertir una mala experiencia en una buena reseña.</p>
</div>

<h3 class="subsection-title">Fase 4: Post-checkout con recordatorio de estrellas</h3>

<div class="script-box">
  <div class="script-box-title">Mensaje</div>
  <p>Hola <span class="highlight">[Nombre]</span>,

Gracias por haberte alojado con nosotros. Ha sido un placer tenerte.

Si tienes un momento, tu valoración en la plataforma nos ayuda muchísimo. Te dejo un pequeño recordatorio sobre lo que significan las estrellas en Airbnb:

<span class="highlight">[ENLACE A INFOGRAFÍA DE ESTRELLAS]</span>

Esperamos volver a verte pronto. ¡Buen viaje de vuelta!</p>
</div>

<div class="cta-banner">
  <h4>Descarga la plantilla del significado de las estrellas</h4>
  <p>Plantilla lista para imprimir o enviar a tus huéspedes explicando qué significa cada valoración y cómo afecta a los anfitriones.</p>
  <a href="/recursos/plantillas/significado-estrellas-airbnb">Descargar plantilla gratis</a>
</div>
...
<ol>
  <li><strong>24-48h antes:</strong> Enlace de check-in + invitación a ver la guía completa</li>
  <li><strong>Cuando está listo:</strong> Confirmación de disponibilidad (autónoma) o confirmación de hora (presencial)</li>
  <li><strong>Al día siguiente:</strong> Mensaje de validación + encuesta de satisfacción</li>
  <li><strong>Post-checkout:</strong> Agradecimiento + recordatorio del significado de las estrellas</li>
...
async function main() {
  ...
  console.log('Artículo actualizado con mensajes corregidos');
}
