  ...
  return (
    <div className="max-w-6xl mx-auto p-3 sm:p-4 lg:p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Planes Personalizados</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-4 sm:mb-6">
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center">
              <Star className="h-6 w-6 sm:h-8 sm:w-8 text-blue-600 mr-2 sm:mr-3" />
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{stats.totalPlans}</h3>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center">
              <Check className="h-6 w-6 sm:h-8 sm:w-8 text-green-600 mr-2 sm:mr-3" />
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{stats.activePlans}</h3>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center">
              <Building className="h-6 w-6 sm:h-8 sm:w-8 text-purple-600 mr-2 sm:mr-3" />
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{stats.hotelPlans}</h3>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center">
              <Users className="h-6 w-6 sm:h-8 sm:w-8 text-orange-600 mr-2 sm:mr-3" />
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{stats.totalSubscriptions}</h3>
                <p className="text-xs sm:text-sm text-gray-600">Subs</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center">
              <Euro className="h-6 w-6 sm:h-8 sm:w-8 text-green-600 mr-2 sm:mr-3" />
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{stats.activeSubscriptions}</h3>
                  ...
                  <div className="flex flex-col sm:flex-row items-start justify-between gap-3">
                    <div className="flex-1 w-full">
                      ...
                      {plan.subscriptions.filter(s => s.status === 'ACTIVE').length > 0 && (
                        <div className="mt-2 sm:mt-3 p-2 sm:p-3 bg-white rounded border border-blue-200">
                          ...
                          <div className="space-y-1">
                            {plan.subscriptions.filter(s => s.status === 'ACTIVE').map((sub) => (
                              <div key={sub.id} className="text-xs sm:text-sm text-gray-600 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                    ...
                    <div className="flex sm:flex-col items-center gap-2 w-full sm:w-auto">
                      ...
                      <Button
                        ...
                        className={`flex-1 sm:flex-none text-xs sm:text-sm ${plan.isActive ? 'text-red-600 border-red-300 hover:bg-red-50' : 'text-green-600 border-green-300 hover:bg-green-50'}`}
                      >
