          ...
          <div key={plan.id} className={`bg-white rounded-lg border-2 ${
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex justify-between items-start mb-3 sm:mb-4">
                ...
                <div className={`ml-2 px-2 py-0.5 sm:py-1 text-xs font-medium rounded-full flex-shrink-0 ${
                  plan.isActive
              ...
              <div className="mb-4 sm:mb-6">
                <div className="flex items-baseline">
                  ...
                  <span className="text-sm sm:text-base text-gray-600 ml-1">/mes</span>
                </div>
                {plan.priceYearly && (
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                ...
                <div className="flex items-center text-xs sm:text-sm">
                  <MessageSquare className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 mr-2 flex-shrink-0" />
                  <span className="text-gray-700">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-gray-100 text-gray-700 text-xs sm:text-sm rounded-lg hover:bg-gray-200 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className={`px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm rounded-lg flex items-center ${
                    plan.isActive
                      ? 'bg-red-100 text-red-700 hover:bg-red-200'
                      : 'bg-green-100 text-green-700 hover:bg-green-200'
                  }`}
                >
                  {plan.isActive ? <X className="w-3 h-3 sm:w-4 sm:h-4" /> : <Check className="w-3 h-3 sm:w-4 sm:h-4" />}
                </button>
              </div>
            </div>
          </div>
