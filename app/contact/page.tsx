      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">¿Puedo usar Itineramio gratis?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Sí, ofrecemos un plan gratuito que incluye funcionalidades básicas. 
                  También tenemos planes premium con características avanzadas.
                </p>
              </CardContent>
            </Card>
