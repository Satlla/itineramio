...
const QUERY_EXPANSIONS: Record<string, string[]> = {
  ...
  // Entry / access verbs — "como entro", "entrar", "abrir la puerta", etc.
  entro:      ['check', 'entrada', 'acceso', 'llave', 'puerta', 'llegada'],
  entrar:     ['check', 'entrada', 'acceso', 'llave', 'puerta', 'llegada'],
  abrir:      ['check', 'llave', 'puerta', 'acceso', 'entrada', 'door'],
  ...
  llegada:    ['check', 'checkin', 'entrada', 'acceso', 'llave'],
  entrada:    ['check', 'checkin', 'acceso', 'llave', 'puerta', 'door'],
  acceso:     ['check', 'checkin', 'entrada', 'llave', 'puerta', 'door'],
  puerta:     ['check', 'llave', 'acceso', 'entrada', 'door', 'lockbox'],
  // Checkout verbs
