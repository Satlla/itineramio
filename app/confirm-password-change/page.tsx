...
// Force dynamic rendering because this page uses useSearchParams
            ...
            <div className="text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-center gap-2 text-sm">
                  ...
                  <span className="text-gray-700 font-medium">Tu nueva contraseña está activa</span>
                </div>
              </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <ul className="space-y-1 text-xs">
                      ...
                      <li>• Tu email sigue siendo el mismo</li>
                      <li>• Has recibido confirmación por email</li>
                    </ul>
                  </div>
                </div>
              </div>
