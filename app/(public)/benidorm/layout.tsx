...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Manual Digital Apartamento Turistico Benidorm | Itineramio', description: 'Crea tu manual digital para huespedes en Benidorm. Normativa, zonas y gestion de vivienda turistica en la Costa Blanca.', url: 'https://www.itineramio.com/benidorm', siteName: 'Itineramio', locale: 'es_ES', type: 'website' },
