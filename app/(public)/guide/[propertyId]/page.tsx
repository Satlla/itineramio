...
const AMENITY_ICON_MAP: Record<string, LucideIcon> = {
  ...
  // Specific amenity icons
  'shower-head': ShowerHead, pipette: Pipette, scroll: Scroll, 'glass-water': GlassWater,
  'bed-double': BedDouble, moon: Moon, 'rectangle-horizontal': RectangleHorizontal,
  'door-closed': DoorClosed, archive: Archive, 'grip-horizontal': GripHorizontal,
  'rotate-cw': RotateCw, baby: Baby, armchair: Armchair, 'chef-hat': ChefHat,
  refrigerator: Refrigerator, microwave: Microwave, 'circle-dot': CircleDot,
  'cup-soda': CupSoda, sandwich: Sandwich, soup: Soup, 'table-2': Table2,
  puzzle: Puzzle, 'lamp-desk': LampDesk, 'alarm-check': AlarmCheck,
  'shield-check': ShieldCheck, cross: Cross, 'flame-kindling': FlameKindling,
  'lock-keyhole': LockKeyhole, 'parking-circle': ParkingCircle,
  'arrow-up-from-line': ArrowUpFromLine, beef: Beef, 'layout-grid': LayoutGrid,
  'door-open': DoorOpen, 'paw-print': PawPrint,
}
