...
export default function FacturamioModulePage() {
  ...
  const module = MODULES.FACTURAMIO
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        ...
        <div className="bg-emerald-50 rounded-2xl p-6 md:p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Escríbenos y te ayudamos a decidir si Facturamio es para ti.
          </p>
          <a
            href="mailto:hola@itineramio.com?subject=Consulta sobre Facturamio"
