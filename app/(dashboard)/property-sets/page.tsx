            ...
            {propertySets.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {propertySets.map((propertySet, index) => (
                  ...
                  >
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => router.push(`/property-sets/${propertySet.id}`)}>
                      <CardContent className="p-6">
                        <div className="flex flex-col h-full">
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              router.push(`/property-sets/${propertySet.id}`)
                            }}
                          >
                            Gestionar
